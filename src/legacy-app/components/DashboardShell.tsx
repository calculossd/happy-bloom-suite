  ...
  <div className="group relative p-[1px] rounded-2xl bg-gradient-to-br from-[#D4A017]/40 via-white/10 to-[#b7ff00]/30">
    ...
    <div className="relative bg-[#0a0c0a]/80 backdrop-blur-2xl rounded-[15px] p-5 border border-white/10 flex items-start gap-5">
      <div className="relative shrink-0">
        ...
        <div className="relative w-16 h-16 rounded-2xl bg-gradient-to-br from-[#1a1f1c] to-[#0a0c0a] border border-white/15 flex items-center justify-center shadow-[inset_0_1px_0_rgba(255,255,255,0.08)] overflow-hidden">
          <img src={robotMascot.url} alt="Assistente" className="w-14 h-14 object-contain drop-shadow-[0_2px_8px_rgba(0,0,0,0.5)]" />
