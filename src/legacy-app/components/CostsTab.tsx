    ...
    <div className="space-y-6" id="costs_tab_container">
      ...
      {activeSubTab === 'STOCK' && (
        <div className="space-y-6 animate-fade-in" id="stocks-physical-layout">
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-[#1A2520] via-[#121A17] to-[#0A0F0D] border border-[#232B27] p-5 rounded-2xl space-y-4 shadow-[0_24px_60px_-30px_rgba(149,187,162,0.25)]" id="product-stock-section">
          ...
          {/* Filamentos Stocks */}
          <div className="relative overflow-hidden bg-gradient-to-br from-[#1A2520] via-[#121A17] to-[#0A0F0D] border border-[#232B27] p-5 rounded-2xl space-y-4 shadow-[0_24px_60px_-30px_rgba(149,187,162,0.25)]">
            <div aria-hidden className="pointer-events-none absolute -top-24 -right-16 h-56 w-56 rounded-full bg-[#b7ff00]/15 blur-3xl opacity-90" />
            <div className="relative grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-b border-white/5 pb-4">
              ...
              <button
                ...
                className="shrink-0 inline-flex items-center gap-1.5 rounded-xl border border-emerald-400/30 bg-emerald-500/15 px-3.5 py-2 text-[11px] font-bold uppercase tracking-[0.12em] text-emerald-100 transition-all duration-300 hover:border-emerald-300/50 hover:bg-emerald-500/25 hover:shadow-[0_8px_24px_-8px_rgba(16,185,129,0.6)] active:scale-[0.97]"
          ...
          <div className="relative overflow-hidden bg-gradient-to-br from-[#1A2520] via-[#121A17] to-[#0A0F0D] border border-[#2B2620] p-5 rounded-2xl space-y-4 shadow-[0_24px_60px_-30px_rgba(229,178,66,0.25)]">
            <div aria-hidden className="pointer-events-none absolute -top-24 -right-16 h-56 w-56 rounded-full bg-[#b7ff00]/15 blur-3xl opacity-90" />
            <div className="relative grid grid-cols-[minmax(0,1fr)_auto] items-center gap-3 border-b border-white/5 pb-4">
              <div className="flex min-w-0 items-center gap-3">
