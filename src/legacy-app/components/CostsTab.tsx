    ...
    <div className="space-y-6" id="costs_tab_container">
      ...
      {activeSubTab === 'STOCK' && (
        <div className="space-y-6 animate-fade-in" id="stocks-physical-layout">
          ...
          />
          {/* THREE D DAYS STOCK AUDIT BANNER — placed below dashboard so the mascote/IA fica acima */}
          <div
          ...
          >
            ...
            <div
              ...
              className={`pointer-events-none absolute inset-y-0 left-0 w-[2px] ${
                isAuditOverdue
                  ...
                  : 'bg-gradient-to-b from-transparent via-[#b7ff00]/60 to-transparent'
              }`}
            />
            <div className="relative grid grid-cols-[minmax(0,1fr)_auto] items-center gap-4 px-5 py-4 sm:px-6 sm:py-5">
                ...
                <div
                  className={`grid h-10 w-10 shrink-0 place-items-center rounded-xl ring-1 ring-inset ${
                    isAuditOverdue
                      ...
                      : 'bg-[#b7ff00]/10 text-[#b7ff00] ring-[#b7ff00]/25'
                  }`}
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`inline-block h-1.5 w-1.5 rounded-full ${
                        isAuditOverdue ? 'bg-rose-400 animate-pulse' : 'bg-[#b7ff00]'
                      }`}
                      style={{
                        boxShadow: isAuditOverdue
                          ? '0 0 10px rgba(244,63,94,0.8)'
                          : '0 0 10px rgba(183,255,0,0.7)',
                      }}
                    />
                    <span
                      className={`text-[10px] font-semibold uppercase tracking-[0.18em] ${
                        isAuditOverdue ? 'text-rose-300/90' : 'text-[#b7ff00]/90'
                      }`}
                    >
              ...
              <button
                ...
                className={`shrink-0 inline-flex items-center gap-2 rounded-xl px-4 py-2.5 text-[11px] font-black uppercase tracking-[0.14em] transition-all duration-300 active:scale-[0.97] ${
                  isAuditOverdue
                    ...
                    : 'bg-[#b7ff00] text-black border border-[#b7ff00] hover:scale-[1.03] shadow-[0_0_20px_rgba(183,255,0,0.35)]'
                }`}
              >
